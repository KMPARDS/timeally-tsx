...
interface MultiSigWalletInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "changeOwnerToDeceased",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isGrantedPermission",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "isNominee", values: [string]): string;
  encodeFunctionData(
    functionFragment: "isOwnerDeceased",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "nomineeMode",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "nominees",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "removeNominee",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "replaceNominee",
  ...
  encodeFunctionData(
    functionFragment: "switchNomineeMode",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "voteMultiplier",
    values: [string]
  ): string;
