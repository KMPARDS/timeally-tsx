...
export class PrepaidEs extends Contract {
  ...
  functions: {
    ...
    convertToESP(_receiver: string, overrides?: PayableOverrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    convertToESP(_receiver: string, overrides?: CallOverrides): Promise<void>;
