...
interface IncentiveInterface extends ethers.utils.Interface {
  functions: {
    ...
    'sendIncentive(address,uint256,uint256,uint256)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'withdrawFund', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'sendIncentive', data: BytesLike): Result;
  ...
  events: {
    ...
    'SendIncentive(address,uint256)': EventFragment;
  };
...
export class Incentive extends Contract {
  ...
  functions: {
    ...
    removeAdmin(user: string, overrides?: Overrides): Promise<ContractTransaction>;

    'removeAdmin(address)'(user: string, overrides?: Overrides): Promise<ContractTransaction>;
    ...
    sendIncentive(
      _buyer: string,
      _value: BigNumberish,
      _incentiveforIntro: BigNumberish,
      _incentiveforTree: BigNumberish,
      overrides?: PayableOverrides
    ): Promise<ContractTransaction>;

    'sendIncentive(address,uint256,uint256,uint256)'(
      _buyer: string,
      _value: BigNumberish,
      _incentiveforIntro: BigNumberish,
      _incentiveforTree: BigNumberish,
  ...
  callStatic: {
    ...
    'removeAdmin(address)'(user: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    SendIncentive(Buyer: null, Value: null): EventFilter;
  };
  ...
  estimateGas: {
    ...
    'removeAdmin(address)'(user: string, overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    removeAdmin(user: string, overrides?: Overrides): Promise<PopulatedTransaction>;

    'removeAdmin(address)'(user: string, overrides?: Overrides): Promise<PopulatedTransaction>;
