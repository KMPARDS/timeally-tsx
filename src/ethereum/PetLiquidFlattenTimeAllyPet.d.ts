...
interface PetLiquidFlattenTimeAllyPetInterface extends ethers.utils.Interface {
  functions: {
...
export class PetLiquidFlattenTimeAllyPet extends Contract {
  ...
  interface: PetLiquidFlattenTimeAllyPetInterface;
