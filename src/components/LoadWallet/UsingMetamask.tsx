        ...
        {(() => {
          switch (this.state.displayScreen) {
            ...
            case 1:
              return (
                <div>
                  You are on "{this.state.network !== null ? this.state.network.name : 'Unknown'}"
                  network in MetaMask, but to use the New TimeAlly you need to connect to the Era
                  Swap Network.
                  <br />
            ...
            case 3:
              return (
                <p>
                  Metamask is not found. If you have Metamask installed, you can try updating it.
                  EIP 1102 proposed a communication protocol between dApps and Ethereum-enabled DOM
                  environments like Metamask.
                </p>
              );
          }
        })()}
