      ...
      <tr>
        ...
        <td>
          {this.state.nextDepositTimestamp
            ? this.getTimeRemaining(this.state.nextDepositTimestamp - this.state.currentTime)
            : 'Calculating...'}
        </td>
        <td>
          {this.state.nextWithdrawTimestamp
            ? this.getTimeRemaining(this.state.nextWithdrawTimestamp - this.state.currentTime)
            : 'Calculating...'}
        </td>
        <td>
          <Button onClick={this.props.onClick}>Open PET</Button>
        </td>
      </tr>
    );
  };
