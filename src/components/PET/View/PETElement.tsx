  ...
  render = () => {
    ...
    return (
      <tr>
        ...
        <td>
          {/* {this.state.nextDepositTimestamp ? window.getTimeRemaining(this.state.nextDepositTimestamp - this.state.currentTime) : 'Calculating...'} */}
          </td>
        <td>
          {/* {this.state.nextWithdrawTimestamp ? window.getTimeRemaining(this.state.nextWithdrawTimestamp - this.state.currentTime) : 'Calculating...'} */}
          </td>
        <td><Button
