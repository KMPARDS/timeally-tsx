      ...
      <div className="outline pinside30 custom-background">
        ...
        <Button
          ...
          <div style={{display:'block', maxWidth: '500px', margin:'0 auto'}}>
            ...
            <Button className="text-white pet-links" href="/pdf/TimeAlly_PET_without_DaySwappers_Incentive.pdf" target="_blank" style={{color: '#000', textDecoration: 'underline', textShadow: '0 0 3px #000a'}}>PET Presenter</Button>
