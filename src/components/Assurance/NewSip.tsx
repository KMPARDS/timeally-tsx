        ...
        <>
          <Card>
            <div className="custom-width" style={{border: '1px solid rgba(0,0,0,.125)', borderRadius: '.25rem', padding:'20px 40px', margin: '15px auto'}}>
              ...
              <Alert variant="success">Your SIP is initiated. You can view your transaction on <a style={{color: 'black'}} href="" target="_blank" rel="noopener noreferrer">EtherScan</a></Alert>
              <Button onClick={() => {
            navigation.navigate('/assurance/view');
          }} >Go to View Assurance SIPs</Button>
            </div>
          </Card>
