...
import { Card, Form,Row, Alert, Button, Spinner, Tabs, Tab, Table, Dropdown, InputGroup, DropdownButton, Modal, Col } from 'react-bootstrap';
  ...
  render() {
    return (
      ...
      <Tab eventKey="home" title="Home">
                      ...
                      <p>Your current vote multiplier is 
                        <Form.Control
                            className="mb-2 homeinput"
                            id="inlineFormInput"
                            placeholder=""
                      ...
                      <div className=""><button type="button" className="btn btn-primary">Confirm</button></div>



                      <p className="mt40">you have 
                      <Form.Control
                          className="mb-2 homeinput"
                          id="inlineFormInput"
                          placeholder=""
      ...
      <Tab eventKey="nominee" title="Nominee">
                      ...
                      <div className="mt40"><button type="button" className="btn btn-primary">Confirm</button></div>
                    ...
                    <div className="row table-padding mt20">
                      ...
                      <div className="mt40"><button type="button" className="btn btn-primary">Submit</button></div>
      ...
      <Tab eventKey="transactions" title="Transactions" >
                       ...
                       <div className="col-md-12 text-right">
                          ...
                          <DropdownButton id="dropdown-basic-button" title="SORT">
                            <Dropdown.Item href="#/action-1" className="filterinput"><InputGroup.Checkbox aria-label="Checkbox for following text input" className="filterinput"/> By Date (Ascending)</Dropdown.Item>
                            <Dropdown.Item href="#/action-2" className="filterinput"><InputGroup.Checkbox aria-label="Checkbox for following text input" /> By Date (Descending)</Dropdown.Item>
                            <Dropdown.Item href="#/action-3" className="filterinput"><InputGroup.Checkbox aria-label="Checkbox for following text input" /> Received by me</Dropdown.Item>
                            <Dropdown.Item href="#/action-3" className="filterinput"> <InputGroup.Checkbox aria-label="Checkbox for following text input" /> Not Received by me</Dropdown.Item>
                            <Dropdown.Item href="#/action-3" className="filterinput"> <InputGroup.Checkbox aria-label="Checkbox for following text input" /> All</Dropdown.Item>
                          </DropdownButton>
                            ...
                            <Table responsive>
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td>0x56d38C60793b64....................79da</td>
                                    <td>20 ES</td>
                                    <td><a href="" className="btn btn-primary" type="button">Pay</a></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>0x56d38C60793b64....................79da</td>
                                    <td>20 ES</td>
                                    <td><a href="" className="btn btn-secondary" type="button">Pay</a></td>
                                    <td>
      ...
      <Tab eventKey="mode" title="Nominee Mode" >
           <h3 >Turn off / on Nominee Mode button
