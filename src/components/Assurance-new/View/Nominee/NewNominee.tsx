      ...
      screen = (
        <Card>
          <div style={{border: '1px solid rgba(0,0,0,.125)', borderRadius: '.25rem', width: '500px', padding:'20px 40px', margin: '15px auto'}}>
            ...
            <p>You can view the transaction on <a href={`https://eraswap.info/txn/${this.state.txHash}`} rel="noopener noreferrer" target="_blank" style={{color: 'black', textDecoration: 'underline', cursor:'pointer'}}>Eraswap.info</a> or you can go back to <span onClick={() => {
