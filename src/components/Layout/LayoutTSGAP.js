...
export class LayoutTSGAP extends Component {
  render = () => (
    <div>
              ...
              <div className="pinside30">
                <div className="row">
                  <div className="col-xl-8 col-lg-8 col-md-3 col-sm-12 col-12">
                    ...
                    {this.props.subtitle ? (
                      <p className="page-subtitle-pet">{this.props.subtitle}</p>
                    ) : null}
                  </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-9 col-sm-12 col-12">
                  {this.props.buttonName ? (
                    <Button className="custom-button" onClick={this.props.buttonOnClick}>
                      {this.props.buttonName}
                    </Button>
                  ) : null}
                </div>
